...
export function MarkdownToolbar({ viewMode, onViewModeChange, onInsert }: MarkdownToolbarProps) {
  return (
    <div className="flex items-center justify-between px-4 h-10 border-b border-[#30363d] bg-[#161b22]/50">
      ...
      <div>
          <MarkdownState viewMode={viewMode} onViewModeChange={onViewModeChange}/>
      </div>
    </div>
  );
}
